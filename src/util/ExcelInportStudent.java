...
public class ExcelInportStudent {
    public static void inportStudent(String fileName, HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException {
        ...
        for (Row r : teacherSheet) {
            ...
            if (checkRowNull(r) == 1) {
                ...
                try {
                    ...
                    //创建实体类
                    Student student = new Student(no, "123456", name, no, sex);
