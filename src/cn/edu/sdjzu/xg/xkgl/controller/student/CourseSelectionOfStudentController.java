...
//将此类声明为Servlet,courseSelectionOfStudentConntroller是该类的映射地址
@WebServlet("/courseSelectionOfStudentController")
public class CourseSelectionOfStudentController extends HttpServlet{
    @Override
